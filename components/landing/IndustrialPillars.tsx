  ...
  const solutions = [
    {
      ...
      description: "Utility-scale rooftop and ground arrays delivering reliable megawatts and displacing costly diesel generation.",
    ...
    },
    {
      ...
      description: "High-yield smart hybrid inverters and modular LiFePO4 battery storage banks engineered for seamless UPS backup.",
      image: "/images/solutions/solutions-inverters.jpg",
    ...
    },
    {
      ...
      image: "/images/solutions/solutions-audit.jpg",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {solutions.map((item, idx) => (
            ...
            >
              <div>
                {/* Top 60% Image Preview Container */}
                <div className="relative h-56 sm:h-60 w-full overflow-hidden bg-slate-950">
                  ...
                  <div className="absolute top-3 left-3">
                    <span className="px-2.5 py-1 rounded-md text-[11px] font-bold bg-slate-900/80 backdrop-blur-md text-white border border-white/10 shadow-sm">
                      {item.tag}
                    </span>
                  </div>
                </div>

                {/* Card Engineering Summary Content */}
                <div className="p-6">
              ...
              <div className="px-6 pb-6 pt-1">
                <Link
                  href={item.href}
                  className="inline-flex items-center gap-1.5 text-xs font-bold text-[#2B82C9] hover:text-sky-600 transition-colors"
                >
